...
请注意，GLM-4-9B 系列对话模型 (不含视觉模型) 实现已经被 Hugging Face transformers 合并并标准化，自 `4.46.0` 版本起，
本仓库模型可能无法正常使用。 请移步适配最新 transformers 的 [模型仓库](https://modelscope.cn/models/ZhipuAI/glm-4-9b-chat-hf) 使用。
...
GLM-4
模型的权重的使用则需要遵循 [LICENSE](https://modelscope.cn/models/ZhipuAI/glm-4-9b-chat/file/view/master?fileName=LICENSE&status=0)。
