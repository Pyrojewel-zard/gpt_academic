...
API_KEY = "sk-t0R0wlY0O6T0NuPYX32eJdkRBiQS8BWiJKqOEsVu0gyoyH0X"    # 可同时填写多个API-KEY，用英文逗号分割，例如API_KEY = "sk-openaikey1,sk-openaikey2,fkxxxx-api2dkey3,azure-apikey4"
# [step 1-2]>> ( 接入通义 qwen-max ) 接入通义千问在线大模型，api-key获取地址 https://dashscope.console.aliyun.com/
DASHSCOPE_API_KEY = "sk-24310d7398384702a047e4469bbacbd5" # 阿里灵积云

# [step 1-3]>> ( 接入 deepseek-reasoner, 即 deepseek-r1 ) 深度求索(DeepSeek) API KEY，默认请求地址为"https://api.deepseek.com/v1/chat/completions"
DEEPSEEK_API_KEY = "sk-G07J4bIt2Qs8JTjD7apQfCum4dSlP7Hs7MTOYbC8whFngGWv"

SILICONCLOUD_DEEPSEEK_API_KEY="sk-vquskvhuouwudvcebthlrndxgenymdvuxmvjizehqpcrkmgq"
...
LLM_MODEL = "volcengine-deepseek-v3-250324" # 可选 ↓↓↓
# AVAIL_LLM_MODELS = ["volcengine-deepseek-r1-250528","volcengine-deepseek-v3-250324","deepseek-r1-671b-64k-thinking","deepseek-v3-671b-64k","qwen2-5-32b-128k","qwen3-32b-128k-thinking","gpt-4.1", "gpt-4.1-mini", "gpt-4.1-nano","gpt-4o-ca",
#                     "o1-preview-ca","o1-mini-ca","gpt-4-ca","gpt-4-turbo-ca",
#                     "gemini-2.0-flash-exp","gemini-1.5-pro","gemini-1.5-flash",
#                     "deepseek-chat" ,"deepseek-coder","deepseek-reasoner","o3-mini","o3-mini-2025-01-31","deepseek-ai/DeepSeek-R1","deepseek-ai/DeepSeek-V3","claude-3-7-sonnet-20250219",
#                     ]
AVAIL_LLM_MODELS = ["volcengine-deepseek-r1-250528","volcengine-deepseek-v3-250324","volcengine-kimi-k2-250711","volcengine-deepseek-v3-1-250821","volcengine-doubao-seed-1-6-vision-250815","volcengine-doubao-seed-1-6-flash-250715","volcengine-doubao-seed-1-6-thinking-250715","deepseek-r1-671b-64k-thinking","deepseek-v3-671b-64k","qwen2-5-32b-128k","qwen3-32b-128k-thinking","gpt-5-ca","gpt-5-mini-ca" "gpt-4.1-mini", "gpt-4.1-nano","gpt-4o-ca",                
                    ]

EMBEDDING_MODEL = "local-http-embed"
...
ARK_API_KEY = "c416ebcc-536b-435e-89a1-a74042c47af6" # 火山引擎 API KEY
...
GROBID_URLS = ["http://localhost:8070/"]
