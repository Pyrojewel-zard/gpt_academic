...
from request_llms.embed_models.bridge_all_embed import embed_model_info
...
class LlamaIndexRagWorker(SaveLoad):
    def __init__(self, user_name, llm_kwargs, auto_load_checkpoint=True, checkpoint_dir=None) -> None:
        ...
        if "embed_endpoint" not in llm_kwargs and "embed_endpoint" in embed_info:
            llm_kwargs["embed_endpoint"] = embed_info["embed_endpoint"]
        self.embed_model = embed_cls(llm_kwargs)
